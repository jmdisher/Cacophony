...
public class TestStartFollowingCommand
{
	...
	public void testUsage() throws Throwable
	{
		...
		StandardEnvironment executor = new StandardEnvironment(System.out, new MemoryConfigFileSystem(null), new MockConnectionFactory(sharedConnection));
	...
	public void testErrorSize() throws Throwable
	{
		...
		StandardEnvironment executor = new StandardEnvironment(new PrintStream(outputStream), filesystem, new MockConnectionFactory(sharedConnection));
		// For this test, we want to just fake a default config.
		StandardAccess.createNewChannelConfig(executor, IPFS_HOST, KEY_NAME);
	...
	{
		StartFollowingCommand command = new StartFollowingCommand(REMOTE_PUBLIC_KEY);
		StandardEnvironment executor = new StandardEnvironment(System.out, new MemoryConfigFileSystem(null), new MockConnectionFactory(null));
