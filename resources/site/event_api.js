...
var EVENTS_API = {
	backgroundStatus: function(onCreate, onUpdate, onDelete, onSocketClose) { createWebSocketStateEventListener("ws://127.0.0.1:8000/backgroundStatus", "event_api"
		, onCreate, onUpdate, onDelete, onSocketClose
	); },
};
