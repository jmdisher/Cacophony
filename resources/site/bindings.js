...
let _template_postMutable = ''
	...
	+ '	<div class="col-md-3">'
	+ '		<a ng-show="null !== postTuple.thumbnailUrl" href="play.html?elt={{postTuple.elementHash}}"><img class="img-fluid" ng-src="{{postTuple.thumbnailUrl}}" alt="{{postTuple.name}}"/></a>'
	+ '		<a ng-show="null === postTuple.thumbnailUrl" href="play.html?elt={{postTuple.elementHash}}">{{postTuple.name}}</a>'
	+ '	</div>'
	+ '	<div class="col-md-9">'
...
let _template_unknownUser = ''
	...
	+ '		<div class="col-md-4">'
	+ '			<a ng-show="null !== tuple.userPicUrl" ng-href="user.html?publicKey={{tuple.publicKey}}"><img class="img-fluid" ng-src="{{tuple.userPicUrl}}" alt="{{tuple.name}}"/></a>'
	+ '			<a ng-show="null === tuple.userPicUrl" ng-href="user.html?publicKey={{tuple.publicKey}}">{{tuple.name}}</a>'
	+ '		</div>'
	+ '		<div class="col-md-8">'
