...
var EVENTS_API = {
	backgroundStatus: function(onSocketOpen, onCreate, onUpdate, onDelete, onSpecial, onSocketClose) { setTimeout(function() {
		// We won't send the open event but we will send the close event, for information.
		onSocketClose({reason:"offline mode"});
	}) },
	processVideo: null,
	existingVideo: null,
	followeeRefresh: function(onSocketOpen, onCreate, onUpdate, onDelete, onSpecial, onSocketClose) { setTimeout(function() {
	...
	userEntries: function(userKey, onSocketOpen, onCreate, onUpdate, onDelete, onSpecial, onSocketClose) { setTimeout(function() {
