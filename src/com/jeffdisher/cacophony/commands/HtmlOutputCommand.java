...
public record HtmlOutputCommand(File _directory) implements ICommand
{
	...
	private void _runCore(IEnvironment environment, IReadingAccess access) throws IpfsConnectionException, UsageException, FailedDeserializationException
	{
		...
		// Generate the record cache we will use to generate the data.
		LocalRecordCache cache = LocalRecordCacheBuilder.buildInitializedRecordCache(access, lastPublishedIndex, followees);
