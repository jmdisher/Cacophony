...
/**
 * <p>Java class for DataArray complex type.
 * 
...
@XmlType(name = "DataArray", propOrder = {
    "element"
})
public class DataArray {

    protected List<DataElement> element;
     ...
     * 
     */
    public List<DataElement> getElement() {
        if (element == null) {
            element = new ArrayList<DataElement>();
        }
        return this.element;
    }
