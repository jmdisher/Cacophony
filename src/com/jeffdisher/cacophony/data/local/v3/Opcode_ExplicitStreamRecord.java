 ...
 */
public record Opcode_ExplicitStreamRecord(IpfsFile streamCid, IpfsFile thumbnailCid, IpfsFile videoCid, IpfsFile audioCid, long combinedSizeBytes) implements IDataOpcode
{
	...
	public static void register(Function<OpcodeDeserializer, IDataOpcode>[] opcodeTable)
	{
		opcodeTable[TYPE.ordinal()] = (OpcodeDeserializer deserializer) -> {
			...
			return new Opcode_ExplicitStreamRecord(streamCid, thumbnailCid, videoCid, audioCid, combinedSizeBytes);
		};
	}
