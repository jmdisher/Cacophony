...
public class InteractiveServer
{
	...
	public static void runServerUntilStop(IEnvironment environment, DraftManager manager, Resource staticResource, int port, String forcedCommand)
	{
		...
		server.addGetHandler("/generated_db.js", 0, new GetGeneratedDbHandler(environment));
	 ...
	 */
	private static class GetGeneratedDbHandler implements IGetHandler
	{
		private final IEnvironment _environment;
		
		public GetGeneratedDbHandler(IEnvironment environment)
		{
			_environment = environment;
		}
